...
class UseCaseQueryWithExternalClausesTest extends \PHPUnit_Framework_TestCase
{
    public function testActivateSomeClausesByConfig()
    {
        ...
        $this->assertInstanceOf('Sirprize\Tests\Queried\UseCaseQueryWithExternalClauses\ArtistClause', $query->getClause('artist'));
        ...
        #die("\n".$query->getClause('artist')->getClause()."\n");
    }
    ...
    public function testActivateAllClausesByConfig()
    {
        ...
        $this->assertInstanceOf('Sirprize\Tests\Queried\UseCaseQueryWithExternalClauses\LabelClause', $query->getClause('label'));
